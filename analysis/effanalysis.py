...
print("Channel 0 efficiency: ", (count[0]/n0_coinc)*100, "%")
print("Channel 1 efficiency: ", (count[1]/n1_coinc)*100, "%")
print("Channel 2 efficiency: ", (count[2]/n2_coinc)*100, "%")
print("Channel 3 efficiency: ", (count[3]/n3_coinc)*100, "%")
